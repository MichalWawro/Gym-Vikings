...
const NavBar = ({ isLoggedIn, handleLoginChange, login, tryingToSign, setTryingToSign }) => {
    ...
    return (
        <div>
            ...
            {isLoggedIn ?
                ...
                :
                <NavBarLoggedOut handleLoginChange={handleLoginChange} tryingToSign={tryingToSign} login={login} setTryingToSign={setTryingToSign}/>
            }
        </div>
    );
};
